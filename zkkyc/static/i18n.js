...
→ 你的交易隐私得到完全保护`,
    ...
    // competitors.html
    'comp.title': '🔍 竞对分析',
    'comp.subtitle': '行业竞品 · 技术对比 · 差异化定位',
    'comp.toc.direct': '🎯 直接竞品',
    'comp.toc.adjacent': '🔗 相近方案',
    'comp.toc.compare': '📊 对比矩阵',
    'comp.toc.landscape': '🗺️ 行业图谱',
    'comp.toc.position': '💡 差异化定位',
    'comp.direct.title': '🎯 直接竞品 — 同赛道 zkKYC 方案',
    'comp.tag.live': '已上线',
    'comp.tag.growing': '快速增长',
    'comp.tag.gov': '政府推动',
    'comp.tag.enterprise': '企业级',
    'comp.zkme.desc': '专做 zkKYC 的项目，Polygon ID 上第一个去中心化凭证发行方。用户做一次 KYC → 拿到 ZK 凭证 → 在多个 DeFi 平台复用。与我们的设计最为接近。',
    'comp.zkme.b1': '✅ 真实 KYC 对接（护照/身份证 OCR + 活体检测）',
    'comp.zkme.b2': '✅ 已集成 Polygon ID 基础设施',
    'comp.zkme.b3': '✅ 多链支持（Ethereum, Polygon, BNB Chain）',
    'comp.zkme.b4': '⚠️ 中心化 KYC 入口，仅验证结果去中心化',
    'comp.polygonid.desc': '目前最成熟的 ZK 身份基础设施。提供完整的发行方→持有方→验证方三角架构，支持 W3C 可验证凭证 + ZK 选择性披露。',
    'comp.polygonid.b1': '✅ 完整 SDK（移动端 + Web + 合约）',
    'comp.polygonid.b2': '✅ zkProof Request Language 链上验证',
    'comp.polygonid.b3': '✅ 动态凭证（可更新状态）',
    'comp.polygonid.b4': '⚠️ 主要绑定 Polygon 生态',
    'comp.zkpass.desc': '无需发行方配合，直接从 Web2 数据源（银行、政府网站）用 zkTLS 技术提取数据并生成 ZK 证明。已发币 $ZKP。',
    'comp.zkpass.b1': '✅ 不依赖发行方，直接从数据源取证',
    'comp.zkpass.b2': '✅ zkTLS 技术 — TLS 会话中生成证明',
    'comp.zkpass.b3': '✅ 覆盖面广：银行、社交、政府数据',
    'comp.zkpass.b4': '⚠️ 依赖 Web2 网站结构，易受改版影响',
    'comp.worldcoin.desc': '通过虹膜扫描（Orb 设备）生成唯一身份证明。不证明"你是谁"，只证明"你是唯一的真人"。争议与热度并存。',
    'comp.worldcoin.b1': '✅ 大规模部署（全球多国设 Orb 点）',
    'comp.worldcoin.b2': '✅ Proof of Personhood 独特定位',
    'comp.worldcoin.b3': '⚠️ 需要专用硬件（Orb）',
    'comp.worldcoin.b4': '⚠️ 生物特征采集引发严重隐私争议',
    'comp.adjacent.title': '🔗 相近方案 — 不同切入点，相似架构',
    'comp.eidas.name': '🇪🇺 欧盟 eIDAS 2.0 / EUDI Wallet',
    'comp.eidas.desc': '欧盟正在推的数字身份钱包，2026-2027 强制落地。政府签发凭证→公民存手机钱包→选择性披露。政策层面最大的行业催化剂。',
    'comp.eidas.b1': '✅ 法律强制：所有欧盟成员国必须支持',
    'comp.eidas.b2': '✅ 覆盖 4.5 亿人口',
    'comp.eidas.b3': '⚠️ 不一定用 ZK（可能是传统选择性披露）',
    'comp.eidas.b4': '⚠️ 进度慢，官僚体系效率低',
    'comp.msft.desc': '微软的企业级去中心化身份方案。公司签发员工/供应商凭证，跨组织验证。主打 B2B 场景。',
    'comp.msft.b1': '✅ 企业客户基础庞大（Azure AD 集成）',
    'comp.msft.b2': '✅ W3C DID / VC 标准',
    'comp.msft.b3': '⚠️ 不针对 crypto/DeFi 场景',
    'comp.msft.b4': '⚠️ 无 ZK 证明，选择性披露有限',
    'comp.dock.desc': '专做可复用 KYC 凭证的平台。IDV 机构签发凭证→用户在多个金融服务间复用。主打"做一次 KYC，到处用"。',
    'comp.dock.b1': '✅ 已有真实 IDV 合作伙伴',
    'comp.dock.b2': '✅ 可复用凭证降低重复 KYC 成本',
    'comp.dock.b3': '⚠️ ZK 能力较弱',
    'comp.sismo.desc': '用 ZK 证明聚合多个身份源（GitHub、Twitter、链上活动），生成隐私保护的身份徽章。偏社交身份验证。',
    'comp.sismo.b1': '✅ 多源身份聚合',
    'comp.sismo.b2': '✅ ZK Attestation 机制',
    'comp.sismo.b3': '⚠️ 不针对合规 KYC 场景',
    'comp.compare.title': '📊 技术对比矩阵',
    'comp.th.project': '项目',
    'comp.th.zk': 'ZK 技术',
    'comp.th.did': 'DID 标准',
    'comp.th.vc': 'W3C VC',
    'comp.th.selective': '选择性披露',
    'comp.th.revocation': '凭证撤销',
    'comp.th.unlinkable': '不可关联',
    'comp.th.onchain': '链上验证',
    'comp.th.issuer': '需发行方',
    'comp.th.status': '状态',
    'comp.status.demo': 'Demo',
    'comp.status.prod': '生产',
    'comp.status.dev': '开发中',
    'comp.eidas.zk': '待定',
    'comp.eidas.tbd': '待定',
    'comp.ms.limited': '有限',
    'comp.dock.zk': '基础',
    'comp.landscape.title': '🗺️ 行业图谱',
    'comp.ls.infra': '🏗️ 基础设施层',
    'comp.ls.app': '📱 应用层',
    'comp.ls.demand': '🏛️ 需求方',
    'comp.ls.demand.reg': '监管机构 — 欧盟 eIDAS, FATF Travel Rule',
    'comp.ls.trad': '🏢 传统身份',
    'comp.ls.trad.eu': '欧盟 EUDI Wallet',
    'comp.ls.trad.idv': '传统 IDV: Jumio, Onfido, Sumsub',
    'comp.position.title': '💡 差异化定位',
    'comp.pos.strength.title': '✅ 我们的优势',
    'comp.pos.strength.desc': '1. 完整的 7 步端到端演示 — 市面上最直观的 zkKYC 教育工具\n2. 同时覆盖技术视角 + 用户视角 + 商业视角，适合不同受众\n3. BBS+ 签名 + Merkle 撤销 + Nullifier 不可关联，三大隐私特性齐全\n4. 中英双语，面向国际受众\n5. 开源 + 一键部署，任何人可以体验',
    'comp.pos.gap.title': '⚠️ 与生产级的差距',
    'comp.pos.gap.desc': '1. 密码学为模拟实现，非生产级安全\n2. 无真实 KYC 数据源对接（OCR、活体检测）\n3. 未接入真实区块链（链上注册表为内存模拟）\n4. 无移动端钱包 SDK\n5. 无多发行方 / 跨链互操作',
    'comp.pos.path.title': '🚀 从 Demo 到产品的最短路径',
    'comp.pos.path.desc': '1. 接入 Polygon ID 基础设施（替换自研密码学）\n2. 对接 zkMe 或自建 KYC 入口\n3. 部署链上 Registry 合约（Polygon / Ethereum）\n4. 开发移动端钱包（存储凭证 + 生成证明）\n5. 找一个 DeFi 协议做首个验证方集成',
...
→ Your transaction privacy is fully protected`,
    ...
    'comp.subtitle': 'Industry Competitors · Tech Comparison · Differentiation',
    'comp.toc.direct': '🎯 Direct Competitors',
    'comp.toc.adjacent': '🔗 Adjacent Solutions',
    'comp.toc.compare': '📊 Comparison Matrix',
    'comp.toc.landscape': '🗺️ Industry Map',
    'comp.toc.position': '💡 Our Position',
    'comp.direct.title': '🎯 Direct Competitors — Same-Track zkKYC Solutions',
    'comp.tag.live': 'Live',
    'comp.tag.growing': 'Growing',
    'comp.tag.gov': 'Gov-Driven',
    'comp.tag.enterprise': 'Enterprise',
    'comp.zkme.desc': 'Dedicated zkKYC project, first decentralized credential issuer on Polygon ID. Users complete KYC once → get ZK credential → reuse across multiple DeFi platforms. Most similar to our design.',
    'comp.zkme.b1': '✅ Real KYC integration (passport/ID OCR + liveness detection)',
    'comp.zkme.b2': '✅ Integrated with Polygon ID infrastructure',
    'comp.zkme.b3': '✅ Multi-chain support (Ethereum, Polygon, BNB Chain)',
    'comp.zkme.b4': '⚠️ Centralized KYC entry, only verification result is decentralized',
    'comp.polygonid.desc': 'Currently the most mature ZK identity infrastructure. Provides complete issuer→holder→verifier triangle, supporting W3C VCs + ZK selective disclosure.',
    'comp.polygonid.b1': '✅ Full SDK (mobile + web + smart contracts)',
    'comp.polygonid.b2': '✅ zkProof Request Language for on-chain verification',
    'comp.polygonid.b3': '✅ Dynamic credentials (updatable state)',
    'comp.polygonid.b4': '⚠️ Primarily tied to Polygon ecosystem',
    'comp.zkpass.desc': 'No issuer needed — directly extracts data from Web2 sources (banks, gov websites) using zkTLS technology to generate ZK proofs. Token: $ZKP.',
    'comp.zkpass.b1': '✅ No issuer dependency, proves directly from data sources',
    'comp.zkpass.b2': '✅ zkTLS technology — generates proofs within TLS sessions',
    'comp.zkpass.b3': '✅ Wide coverage: banking, social, government data',
    'comp.zkpass.b4': '⚠️ Depends on Web2 site structure, vulnerable to redesigns',
    'comp.worldcoin.desc': 'Generates unique identity proof via iris scanning (Orb device). Doesn\'t prove "who you are", only proves "you are a unique human". Controversial yet popular.',
    'comp.worldcoin.b1': '✅ Large-scale deployment (Orb locations worldwide)',
    'comp.worldcoin.b2': '✅ Unique "Proof of Personhood" positioning',
    'comp.worldcoin.b3': '⚠️ Requires specialized hardware (Orb)',
    'comp.worldcoin.b4': '⚠️ Biometric collection raises serious privacy concerns',
    'comp.adjacent.title': '🔗 Adjacent Solutions — Different Entry Points, Similar Architecture',
    'comp.eidas.name': '🇪🇺 EU eIDAS 2.0 / EUDI Wallet',
    'comp.eidas.desc': 'EU digital identity wallet, mandatory rollout 2026-2027. Government issues credentials → citizens store in mobile wallet → selective disclosure. Biggest policy-level industry catalyst.',
    'comp.eidas.b1': '✅ Legally mandated: all EU member states must support',
    'comp.eidas.b2': '✅ Covers 450 million people',
    'comp.eidas.b3': '⚠️ May not use ZK (could be traditional selective disclosure)',
    'comp.eidas.b4': '⚠️ Slow progress, bureaucratic inefficiency',
    'comp.msft.desc': 'Microsoft\'s enterprise decentralized identity solution. Companies issue employee/vendor credentials for cross-org verification. B2B focused.',
    'comp.msft.b1': '✅ Massive enterprise customer base (Azure AD integration)',
    'comp.msft.b2': '✅ W3C DID / VC standards',
    'comp.msft.b3': '⚠️ Not targeting crypto/DeFi scenarios',
    'comp.msft.b4': '⚠️ No ZK proofs, limited selective disclosure',
    'comp.dock.desc': 'Platform for reusable KYC credentials. IDV providers issue credentials → users reuse across multiple financial services. "One KYC, use everywhere".',
    'comp.dock.b1': '✅ Real IDV partners onboarded',
    'comp.dock.b2': '✅ Reusable credentials reduce repeated KYC costs',
    'comp.dock.b3': '⚠️ Weak ZK capabilities',
    'comp.sismo.desc': 'Uses ZK proofs to aggregate multiple identity sources (GitHub, Twitter, on-chain activity) into privacy-preserving identity badges. Social identity focused.',
    'comp.sismo.b1': '✅ Multi-source identity aggregation',
    'comp.sismo.b2': '✅ ZK Attestation mechanism',
    'comp.sismo.b3': '⚠️ Not targeting compliance KYC scenarios',
    'comp.compare.title': '📊 Technical Comparison Matrix',
    'comp.th.project': 'Project',
    'comp.th.zk': 'ZK Tech',
    'comp.th.did': 'DID Standard',
    'comp.th.vc': 'W3C VC',
    'comp.th.selective': 'Selective Disclosure',
    'comp.th.revocation': 'Revocation',
    'comp.th.unlinkable': 'Unlinkable',
    'comp.th.onchain': 'On-chain Verify',
    'comp.th.issuer': 'Needs Issuer',
    'comp.th.status': 'Status',
    'comp.status.demo': 'Demo',
    'comp.status.prod': 'Production',
    'comp.status.dev': 'In Development',
    'comp.eidas.zk': 'TBD',
    'comp.eidas.tbd': 'TBD',
    'comp.ms.limited': 'Limited',
    'comp.dock.zk': 'Basic',
    'comp.landscape.title': '🗺️ Industry Landscape',
    'comp.ls.infra': '🏗️ Infrastructure Layer',
    'comp.ls.app': '📱 Application Layer',
    'comp.ls.demand': '🏛️ Demand Side',
    'comp.ls.demand.reg': 'Regulators — EU eIDAS, FATF Travel Rule',
    'comp.ls.trad': '🏢 Traditional Identity',
    'comp.ls.trad.eu': 'EU EUDI Wallet',
    'comp.ls.trad.idv': 'Traditional IDV: Jumio, Onfido, Sumsub',
    'comp.position.title': '💡 Differentiation & Positioning',
    'comp.pos.strength.title': '✅ Our Strengths',
    'comp.pos.strength.desc': '1. Complete 7-step end-to-end demo — most intuitive zkKYC educational tool on the market\n2. Covers technical + user + business perspectives for different audiences\n3. BBS+ signatures + Merkle revocation + Nullifier unlinkability — all three privacy features\n4. Bilingual Chinese/English, targeting international audiences\n5. Open source + one-click deploy, anyone can experience it',
    'comp.pos.gap.title': '⚠️ Gap to Production',
    'comp.pos.gap.desc': '1. Cryptography is simulated, not production-grade security\n2. No real KYC data source integration (OCR, liveness detection)\n3. No real blockchain connected (on-chain registry is in-memory simulation)\n4. No mobile wallet SDK\n5. No multi-issuer / cross-chain interoperability',
    'comp.pos.path.title': '🚀 Shortest Path from Demo to Product',
    'comp.pos.path.desc': '1. Integrate Polygon ID infrastructure (replace custom cryptography)\n2. Connect zkMe or build own KYC entry point\n3. Deploy on-chain Registry contract (Polygon / Ethereum)\n4. Develop mobile wallet (store credentials + generate proofs)\n5. Find one DeFi protocol as first verifier integration',
...
function applyTranslations() {
  ...
  } else if (htmlEl.getAttribute('data-page') === 'competitors') {
    document.title = currentLang === 'zh' ? 'zkKYC — 竞对分析' : 'zkKYC — Competitor Analysis';
